...
def tax1():
    ...
    def tax():
        ...
        def htaxredution():
            htaxredution = int(hTaxthereon())*0.75
            if htaxredution <= 20000:
                return htaxredution
            else: htaxredution = 20000
            return htaxredution
        ...
        def wtaxredution():
            wtaxredution = int(wTaxthereon())*0.75
            if wtaxredution <= 20000:
                return wtaxredution
            else: wtaxredution = 20000
            return wtaxredution
        ...
        def jtaxredution():
            jtaxredution = int(jTaxthereon())*0.75
            if jtaxredution <= 20000:
                return jtaxredution
            else: jtaxredution = 20000
            return jtaxredution
        ...
        Label(window_01, text="Less : 75% tax reduction (Max: 20000)").grid(row=13, column=0)
